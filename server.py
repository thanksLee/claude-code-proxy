...
OPENAI_MODELS = get_ollama_models()
...
async def create_message(
    ...
    try:
        ...
        if request.model.startswith("openai/"):
            ...
            if OPENAI_BASE_URL:
                litellm_request["openai_base_url"] = OPENAI_BASE_URL
        ...
        # In create_message
        logger.error(f"Error processing request: {json.dumps(make_json_serializable(error_details), indent=2)}")
